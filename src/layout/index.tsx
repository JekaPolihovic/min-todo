...
export default function Layout({ children }: LayoutProps): ReactNode {
  return (
    <div className="flex justify-center">
      <div className="bg-lightestgrey px-5 py-4 w-5/12 flex flex-col shadow items-center">
        <h1 className="text-lightred text-center text-8xl font-helvetica-light font-thin lowercase mb-3">
          Todos
        </h1>
        <div className="bg-white shadow w-[560px]">{children}</div>
