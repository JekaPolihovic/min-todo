...
export default function TodoInput(): ReactNode {
  ...
  return (
    ...
    >
      <button data-testid="submit" className="bg-transparent px-3 py-4">
        <svg
      ...
      <div className="grow flex bg-transparent">
        <input
          className="w-full text-dark text-2xl font-thin placeholder:italic placeholder:text-lightgrey focus:outline-none ml-1"
